...
function binary_to_base64(e) {
  ...
  if (n) {
    ...
    for (
      ...
      r += base64_chars.charAt(o[i]);
    for (; n++ < 3; ) r += "=";
  }
  return r;
}
function dec2hex(e) {
  for (var t = hD.substr(15 & e, 1); e > 15; )
    (e >>= 4), (t = hD.substr(15 & e, 1) + t);
  return t;
}
function base64_decode(e) {
  ...
  for (var u = 0; c < e.length; )
    (i = keyStr.indexOf(e.charAt(c++))),
      (a = keyStr.indexOf(e.charAt(c++))),
      (o = keyStr.indexOf(e.charAt(c++))),
      (s = keyStr.indexOf(e.charAt(c++))),
      (t = (i << 2) | (a >> 4)),
      (r = ((15 & a) << 4) | (o >> 2)),
      (n = ((3 & o) << 6) | s),
      (d[u++] = t),
          ...
          var t = JSON.parse(e.data),
            ...
            o = function(e, n) {
              t.push(function(e, t) {
                (r.data = e),
                  (r.complete = !1 !== t),
                  bridge.call("_dsb.returnValue", r);
              }),
                e.apply(n, t);
            };
          if (n) a(n, this._dsf);
    ...
    bridge.register("_hasJavascriptMethod", function(e, t) {
      return (
        ...
        2 > t.length
          ...
          : ((e = t.pop()),
            (t = t.join(".")),
            (t = _dsf._obs[t] || _dsaf._obs[t]) && !!t[e])
      );
    });
  }
})();
